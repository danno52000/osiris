        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex gap-2">
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('🏛️ GIDEON — Cross-Domain Intelligence Platform')}&url=${encodeURIComponent(generateShareUrl())}`}
                target="_blank"
              ...
              <a
                href={`https://reddit.com/submit?url=${encodeURIComponent(generateShareUrl())}&title=${encodeURIComponent('GIDEON — Cross-Domain Intelligence Platform')}`}
                target="_blank"
